                    ...
                    {floodWait ? (
                        ...
                        >
                            ...
                            <p className="text-xs text-red-400/60 mt-4">
                                Do not refresh the page. The timer will reset if you do.
                            </p>
                        </motion.div>
                    ) : (
                        <>
                            ...
                            <div className="space-y-6 text-telegram-text">
                                <div className="p-4 bg-telegram-primary/10 border border-telegram-primary/20 rounded-xl">
                                    <p className="text-sm text-telegram-subtext">
                                        <strong className="text-telegram-primary">Cloudsphere Space</strong> uses your Telegram account as secure cloud storage. You'll need a Telegram account and API credentials to get started.
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    ...
                                    <p className="text-sm text-telegram-subtext ml-8">
                                        Visit <a href="https://my.telegram.org" target="_blank" rel="noopener noreferrer" className="text-telegram-primary underline hover:text-telegram-text">my.telegram.org</a> and log in with your phone number.
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    <h3 className="font-semibold flex items-center gap-2">
                                ...
                                <div className="p-4 bg-telegram-hover rounded-xl border border-telegram-border">
                                    <p className="text-xs text-telegram-subtext">
                                        <strong>🔒 Privacy:</strong> Your credentials are stored locally and are never sent to any third-party servers. All data goes directly between you and Telegram.
                                    </p>
                                </div>
                                <a
                    ...
                    >
                        ...
                        >
                            <div className="relative flex items-center justify-center mb-6">
                                <h2 className="text-xl font-bold text-telegram-text text-center">Support the Project</h2>
                            ...
                            <div className="space-y-4 text-center">
                                <p className="text-sm text-telegram-subtext mb-6">
                                    If you find Cloudsphere Space useful, consider supporting its development!
                                </p>
                                <div className="space-y-4">
                                    <a href="https://www.paypal.me/Caamer20" target="_blank" rel="noopener noreferrer" className="block hover:opacity-80 transition-opacity">
